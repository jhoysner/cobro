    ...
    <nav class="navbar navbar-custom " style="background:rgb(9,99,90);">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <span class="text-white" href=""><img src="{{ asset('/img/escudoGirardot.png') }}" width="40"/>Girardot Para Seguir Avanzando</span>
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                     ...
                     <li class="page-scroll">
                        <a class="btn btn-link text-white" href="{{ route('login') }}">ENTRAR</a>
                    </li>
                    <li class="page-scroll">
                        <a class="btn btn-link text-white" href="{{ route('register') }}">NUEVO USUARIO</a>
                    </li>
                    <li class="page-scroll">
        ...
        <!-- /.container-fluid -->
        <div class="lema">
        <marquee><h4 class="text-center text-white">Felicitaciones al Municipio de Girardot, adquirió el nuevo Software Especializado en Derecho Procesal Administrativo !
        ...
        Girardot les desea Feliz Navidad y Prospero Año 2018</h4></marquee>
        </div>
    </nav>
