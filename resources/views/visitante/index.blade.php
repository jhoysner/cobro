...
<div id="encabezado" class="row col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div id="contenedor_buscar" class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                    <h4 class="card-title text-principal text-center"><b>Municipio de Girardot</b></h4>
                    <center><img class="card-img-top" src="{{ asset('img/logoGirardot.png') }}" alt="Card image cap" width="80"></center>
